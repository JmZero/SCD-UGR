...
void TareaA(void)
{
	...
	clock_nanosleep( CLOCK_REALTIME, TIMER_ABSTIME, &tComputo,NULL );
...
void TareaD(void)
{
	...
	// EJERCICIO DE CLASE: si ponemos en la tarea D un tiempo de cómputo de 5, el ciclo número 2 que contiene las tareas A, B, D
	// completaría los 5 milisegundos y esto retrasaría la activación y ejecución del siguiente ciclo, retrasando la tarea A que
	// es la primera en computarse
